...
#加载公共函数
source "${0%/*}/until_function.sh"

#指定目录和输出文件
Sort_Folder="${0%/*}/temple/sort" 
Download_Folder="${0%/*}/temple/download_Rules"
Combine_Folder="${0%/*}/temple/combine"
Rules_Folder="${0%/*}/Rules"
Base_Rules_Folder="${0%/*}/base"
...
rm -rf "${Combine_Folder}"/*.txt "${Combine_Folder}"/lite/*.txt
#Full
...
make_white_rules "${Rules_Folder}/adblock_auto.txt"
...
make_white_rules "${Rules_Folder}/adblock_auto_lite.txt"
